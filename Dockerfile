...
COPY Container.Dependencies/webssh.zip Container.Dependencies/ssh /tmp/
...
COPY Container.Dependencies/custom_scripts/* /custom_scripts/
RUN chmod 755 /custom_scripts/*

COPY Container.Dependencies/deploy.bash.ruby.template /opt/Kudu/node_modules/kuduscript/lib/templates/deploy.bash.ruby.template
COPY Container.Dependencies/deploy.bash.ruby.template /opt/Kudu/KuduConsole/node_modules/kuduscript/lib/templates/deploy.bash.ruby.template
